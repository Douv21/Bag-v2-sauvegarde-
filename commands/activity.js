...
module.exports = {
  ...
  async execute(interaction) {
    try {
      ...
      await interaction.reply({ content: '✅ Activité enregistrée. Merci !', flags: 64 });
    } catch (e) {
      console.error('Erreur /je-suis-actif:', e);
      await interaction.reply({ content: '❌ Impossible de signaler votre activité pour le moment.', flags: 64 });
    }
  }
};